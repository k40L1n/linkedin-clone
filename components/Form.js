...
function Form() {
  ...
  return (
    <form className="flex flex-col relative space-y-2 text-black/80 dark:text-white/75">
      ...
      />
      <button
        className="absolute bottom-0 right-0 font-medium bg-blue-500 hover:bg-blue-600 disabled:text-black/40 disabled:bg-white/75 disabled:cursor-not-allowed text-white rounded-full px-3.5 py-1"
        // toggle the state of the button depending on the input and the photoUrl Variables
