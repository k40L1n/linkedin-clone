...
function Sidebar() {
  ...
  return (
    <div className="space-y-2 min-w-max max-w-lg">
      ...
      {/* Bottom */}
      <div className="hidden md:flex bg-white dark:bg-[#1D2226] text-black dark:text-white/75 rounded-lg overflow-hidden flex-col space-y-2 pt-2.5 sticky top-20 border border-gray-300 dark:border-none">
