...
// Modal is receiving two props, handleClose closes the modal.

const Modal = ({ handleClose, type }) => {
  const { data: session } = useSession()
  // userecoilvalue is different from the useRecoilState, its used when we only need the value and not the setter function that is associated with it
